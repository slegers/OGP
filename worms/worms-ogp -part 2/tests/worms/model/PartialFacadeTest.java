...
public class PartialFacadeTest {
	...
	public void testMoveHorizontal() {
		Worm worm = facade.createWorm(world, 1, 2, 0, 1, "Test");
		facade.move(worm);
		assertEquals(2, facade.getX(worm), EPS); // error due to double rounding mistakes, not sure how to fix this...
	...
	public void testRadius(){
		...
		Worm worm = facade.createWorm(world, 1.5, 2.5, -Math.PI / 2, 0.5,
				"Test");
		facade.setRadius(worm, 1.0);
		assertEquals(facade.getRadius(worm), 1.0, 0.000000001);
	}
	@Test
	public void testRename(){
		...
		Worm worm = facade.createWorm(world, 1.5, 2.5, -Math.PI / 2, 0.5,
				"Test");
		facade.rename(worm, "Ed");
		assertEquals(facade.getName(worm), "Ed");
		assertEquals(facade.getName(worm), worm.getName());
	}
	@Test
	public void testGetMass(){
		...
		Worm worm = facade.createWorm(world, 1.5, 2.5, -Math.PI / 2, 0.5,
				"Test");
		assertEquals(facade.getMass(worm), worm.getMass(), 0.00000001);
		}
	@Test
	public void testGetActionPoints(){
		...
		Worm worm = facade.createWorm(world, 1.5, 2.5, -Math.PI / 2, 0.5,
				"Test");
		assertEquals(facade.getActionPoints(worm), worm.getActionPoints());
